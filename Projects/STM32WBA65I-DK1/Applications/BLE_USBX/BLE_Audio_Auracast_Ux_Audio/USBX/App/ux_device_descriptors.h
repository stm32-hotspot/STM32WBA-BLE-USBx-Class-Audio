...
#ifndef DEMO_STEREO
#undef USBD_AUDIO_PLAY_CHANNEL_COUNT
#undef USBD_AUDIO_PLAY_CHANNEL_MAP
#undef USBD_AUDIO_PLAY_EPOUT_HS_MPS

#define USBD_AUDIO_PLAY_CHANNEL_COUNT                 4U
#define USBD_AUDIO_PLAY_CHANNEL_MAP                   0x33U
#define USBD_AUDIO_PLAY_EPOUT_HS_MPS                  512*3U
